...
const Calendar = () => (
    <div>
        ...
        <ContentContainer>
            <PageTitle>Reserveringssyteem</PageTitle>
            <TechniquesContainer>
            ...
            <InformationContainer className="post-information">
                <InformationText className="post-text">Tijdens dit project moest ik een reserveringssyteem bouwen voor een echte klant.
                    <br /><br />
                    Ik ben daarom ook opzoek gegaan en terecht gekomen bij de lokale speeltuin(Rollebollebos) bij mij in de buurt. Na verschillende ontmoetingen met de opdrachtgever wist ik hoe hij het wilde hebben en ben ik aan de slag gegaan.
                    <br /><br />
