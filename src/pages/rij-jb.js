...
const RijJb = () => (
    <div>
        ...
        <ContentContainer>
            <PageTitle>Autorijschool JB</PageTitle>
            <TechniquesContainer>
                <Technique>HTML</Technique>
                <Technique>CSS</Technique>
            </TechniquesContainer>
            <InformationContainer className="post-information">
                <InformationText className="post-text">Op maat gemaakte Website in HTML en CSS.
                    <br />
                    <br />
                ...
                <InformationImage className="post-image" src="img/work/rij-jb.png" />
